...
export const commands = {
	 ...
	 */
	readPromptPartsText: (threadId: string, window: HomeRoute | null = null) => __TAURI_INVOKE<PromptPart[]>("read_prompt_parts_text", { threadId, window }),
	 ...
	 */
	updateTurnSettings: (threadId: string, turnId: string, model: string | null, effort: string | null, speedTier: string | null, window: HomeRoute | null = null) => __TAURI_INVOKE<unknown>("update_turn_settings", { threadId, turnId, model, effort, speedTier, window }),
	 ...
	 */
	threadGoalSet: (threadId: string, objective: string | null, status: string | null, tokenBudget: number | null, clearTokenBudget: boolean | null, window: HomeRoute | null = null) => __TAURI_INVOKE<unknown>("thread_goal_set", { threadId, objective, status, tokenBudget, clearTokenBudget, window }),
	...
	gitContext: (dir: string, window: HomeRoute | null = null) => __TAURI_INVOKE<GitContext>("git_context", { dir, window }),
	gitStage: (dir: string, paths: string[], window: HomeRoute | null = null) => __TAURI_INVOKE<null>("git_stage", { dir, paths, window }),
	gitUnstage: (dir: string, paths: string[], window: HomeRoute | null = null) => __TAURI_INVOKE<null>("git_unstage", { dir, paths, window }),
	gitDiscard: (dir: string, paths: string[], untrackedPaths: string[], window: HomeRoute | null = null) => __TAURI_INVOKE<null>("git_discard", { dir, paths, untrackedPaths, window }),
	gitCommit: (dir: string, message: string, window: HomeRoute | null = null) => __TAURI_INVOKE<CommitResult>("git_commit", { dir, message, window }),
	gitFetch: (dir: string, window: HomeRoute | null = null) => __TAURI_INVOKE<SyncResult>("git_fetch", { dir, window }),
	gitPull: (dir: string, window: HomeRoute | null = null) => __TAURI_INVOKE<SyncResult>("git_pull", { dir, window }),
	gitPush: (dir: string, setUpstream: boolean, window: HomeRoute | null = null) => __TAURI_INVOKE<SyncResult>("git_push", { dir, setUpstream, window }),
	gitCheckoutBranch: (dir: string, name: string, force: boolean, window: HomeRoute | null = null) => __TAURI_INVOKE<null>("git_checkout_branch", { dir, name, force, window }),
	gitCreateBranch: (dir: string, name: string, base: string | null, checkout: boolean, window: HomeRoute | null = null) => __TAURI_INVOKE<null>("git_create_branch", { dir, name, base, checkout, window }),
	/**  The index versus HEAD for one path: what a commit would contain. */
	gitStagedFileDiff: (dir: string, path: string, maxBytes: number | null, window: HomeRoute | null = null) => __TAURI_INVOKE<FileDiff>("git_staged_file_diff", { dir, path, maxBytes, window }),
	...
	listIntegrations: (cwds: string[] | null, forceReload: boolean | null, window: HomeRoute | null = null) => __TAURI_INVOKE<IntegrationsList>("list_integrations", { cwds, forceReload, window }),
	...
	setIntegrationEnabled: (kind: IntegrationKind, id: string, enabled: boolean | null, projectPath: string | null, window: HomeRoute | null = null) => __TAURI_INVOKE<IntegrationsList>("set_integration_enabled", { kind, id, enabled, projectPath, window }),
	/**
	 *  Enable or disable a skill by name. `skills/config/write` requires exactly
	 *  one of `name` or `path`; we always key by name.
	 */
	setSkillEnabled: (name: string, enabled: boolean, path: string | null, window: HomeRoute | null = null) => __TAURI_INVOKE<unknown>("set_skill_enabled", { name, enabled, path, window }),
 ...
 */
{ type: "mode_changed"; mode: string } | { type: "notice"; level: string; text: string } | { type: "request_cancelled"; requestId: number };
...
export type ThreadModeChangedParams = {
	threadId?: string | null,
	mode?: string | null,
};
